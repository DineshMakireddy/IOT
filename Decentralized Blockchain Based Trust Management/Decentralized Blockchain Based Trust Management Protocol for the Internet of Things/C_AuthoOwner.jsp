...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24">Authorize Service Providers !!! </h2>
          <p>&nbsp;</p>
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="183" bgcolor="#FFFF00"><div align="center" class="style25">Service Provider  Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td><div align="center" class="style26"><a href="C_OwnerDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
