      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form action="EU_Download2.jsp" method="post" id="form1">
            <p><span class="style7 style25 style27">
              <%
			  String role="";
	try 
		{  
		...
		String strQuery = "select * from fognode where fname='"+file+"'";
		...
		if(rs.next()==true)
		{
			...
			if(trapdoor.equalsIgnoreCase("Shared"))
			{
				...
				String quey1="select * from fognode  where fname='"+fn+"' "; 
				...
				if ( rs1.next())
				{
					...
					if(rs12.next()==true)
					{
						...
						{
							%>
							decryptkey Not Authorized By Fog Node !</span></p>
							<p class="style28"><a href="EU_Main.jsp">Back</a><span class="style29">
							<%
						}
						else if(decryptkey.equalsIgnoreCase("No"))
						{
							%>
							decryptkey Not Requested !</span><a href="EU_Main.jsp">Back</a><span class="style29">
							<%
						}
						else
						{
							...
							{
								%>
								Secret Key Not Permitted ! </span><a href="EU_Main.jsp">Back</a></p>
							<p><span class="style25 style7"><strong>
								<%
							}
							else if(secretkey.equalsIgnoreCase("No"))
							{
								%>
								Secret Key Not Requested !</strong></span></p>
					...
					<p class="style28"><a href="EU_Main.jsp">Back</a></p>
					<p class="style22">
					  <%
					}
				}
			...
			if(rs1.next()==true)
			{
				...
				if(decryptkey.equalsIgnoreCase("Requested"))
				{
					...
					decryptkey Not Authorized By Fog Node !</span></p>
					<p class="style28"><a href="EU_Main.jsp">Back</a></p>
					<p class="style28"><span class="style29">
					<%
				}
				else if(decryptkey.equalsIgnoreCase("No"))
				{
